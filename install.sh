...
release_url="https://api.github.com/repos/ncarlier/apimon/releases/latest"
...
download_url=$base_download_url/apimon-$os-${arch}.tgz
download_file=/tmp/apimon-$os-${arch}.tgz
bin_target=/usr/local/bin/apimon
...
sudo mv /tmp/release/apimon* $bin_target
